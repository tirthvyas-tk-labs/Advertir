package com.project.adverstir.ui.settings;
...
import com.project.adverstir.ui.onboarding.OnboardingActivity;
...
public class MoreRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MoreRecyclerViewAdapter(Context cxt, Activity av, int section) {
        ...
        if (section == 0) {
            ...
            titles.add(cxt.getString(R.string.about_sarscovid));
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (titles.get(position).equals(cxt.getString(R.string.share_text))) {
        ...
        else if (titles.get(position).contains(cxt.getString(R.string.about_sarscovid))) {
            ((MoreCard)holder).card.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
            ...
            ((MoreCard)holder).button.setVisibility(View.INVISIBLE);
            ((MoreCard)holder).card.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    onClickBehavior();
